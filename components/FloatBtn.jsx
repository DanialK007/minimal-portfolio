...
function FloatBtn({children, className}) {
  return (
    <div className={classNames("block group relative border overflow-hidden border-black uppercase px-2 py-1 w-fit mt-10 rounded-s-full rounded-e-full hover:bg-black hover:text-white", className)}>
